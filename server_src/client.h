 ...
 *
 * Defines data structures used to represent a connected or offline client, including connection state, protocol buffers, session data, and room/game membership
 *
